...
import { MainCountriesAdmin } from "@/admin/mainCountries/MainCountriesAdmin";
      ...
      <Router basename="/admin">
        <Routes>
          ...
          >
            ...
            <Route
              path="admin/double-decker-stands"
              element={<DoubleDeckStandsAdmin />}
            />
            <Route
              path="admin/modular-stands"
              element={<ModularStandsAdmin />}
            />
            <Route
              path="admin/pavilion-stands"
              element={<PavilionStandsAdmin />}
            />
            <Route
              path="admin/trade-shows-page"
              element={<TradeShowsPageAdmin />}
            />
            <Route path="admin/trade-shows" element={<TradeShowsAdmin />} />
            <Route
              path="admin/trade-shows/create"
              element={<CreateTradeShowAdmin />}
            />
            <Route
              path="admin/trade-shows/:id/edit"
              element={<EditTradeShowAdmin />}
            />
            ...
            <Route
              ...
              element={<CreateBlogPostAdmin />}
            />
            <Route
              path="admin/blog-posts/:id/edit"
              element={<EditBlogPostAdmin />}
            />
            ...
            <Route
              ...
              element={<EditCountryAdmin />}
            />
            <Route path="admin/sitemap" element={<SitemapAdmin />} />
            <Route
              path="admin/main-countries"
              element={<MainCountriesAdmin />}
            />
          </Route>
        </Routes>
      </Router>
