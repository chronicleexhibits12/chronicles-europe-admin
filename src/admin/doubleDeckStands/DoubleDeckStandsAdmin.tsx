...
export function DoubleDeckStandsAdmin() {
  ...
  const handleImageUpload = async (file: File, section: string, field: string) => {
    ...
    const uploadPromise = DoubleDeckStandsPageService.uploadImage(file)
    ...
    toast.promise(savePromise, {
      ...
      success: (result) => {
        if (result.data) {
          ...
          return 'Double decker stands page updated successfully!'
        } else {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  value={formData.boothPartner?.title || ''}
                  onChange={(e) => handleInputChange('boothPartner', 'title', e.target.value)}
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  value={formData.boothPartner?.subtitle || ''}
                  onChange={(e) => handleInputChange('boothPartner', 'subtitle', e.target.value)}
                />
              </div>
            </div>
            <div className="w-full">
              ...
              <RichTextEditor
                content={formData.boothPartner?.description || ''}
                onChange={(newContent) => handleInputChange('boothPartner', 'description', newContent)}
                controlled={true}
              />
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  value={formData.boldStatement?.title || ''}
                  onChange={(e) => handleInputChange('boldStatement', 'title', e.target.value)}
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  value={formData.boldStatement?.subtitle || ''}
                  onChange={(e) => handleInputChange('boldStatement', 'subtitle', e.target.value)}
                />
              </div>
            </div>
            <div className="w-full">
              ...
              <RichTextEditor
                content={formData.boldStatement?.description || ''}
                onChange={(newContent) => handleInputChange('boldStatement', 'description', newContent)}
                controlled={true}
              />
            </div>
          </div>
