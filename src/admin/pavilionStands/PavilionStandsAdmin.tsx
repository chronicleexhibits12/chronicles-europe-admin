    ...
    <div className="w-full">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Edit your pavilion stands page content and images
        </p>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handleInputChange("hero", "buttonTitle", e.target.value)
                }
          ...
          <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <Input
                      ...
                      onChange={(e) =>
                        updateImageAlt("benefits", "image", e.target.value)
                      }
                      placeholder="Alt text"
                    />
                  </div>
                ...
                {getCurrentImageUrl("benefits", "image") && (
                  <div className="relative inline-block">
                    <img
                      ...
                      alt={
                        getCurrentImageAlt("benefits", "image") ||
                        "Benefits preview"
                      }
                      className="max-h-16 object-cover rounded border"
                    />
            ...
            <div className="w-full">
              ...
              <RichTextEditor
                ...
                onChange={(newContent) =>
                  handleInputChange("benefits", "content", newContent)
                }
                controlled={true}
              />
            </div>
          ...
          <div className="space-y-4">
            <div className="w-full">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleInputChange("whyChoose", "title", e.target.value)
                }
              />
            </div>
            <div className="w-full">
              ...
              <RichTextEditor
                ...
                onChange={(newContent) =>
                  handleInputChange("whyChoose", "content", newContent)
                }
                controlled={true}
              />
            </div>
          ...
          <div className="space-y-4">
            <div className="w-full">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleInputChange("advantages", "title", e.target.value)
                }
              />
            </div>
            <div className="w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <Input
                      ...
                      onChange={(e) =>
                        updateImageAlt("advantages", "image", e.target.value)
                      }
                      placeholder="Alt text"
                    />
                  </div>
                ...
                {getCurrentImageUrl("advantages", "image") && (
                  <div className="relative inline-block">
                    <img
                      ...
                      alt={
                        getCurrentImageAlt("advantages", "image") ||
                        "Advantages preview"
                      }
                      className="max-h-16 object-cover rounded border"
                    />
            ...
            <div className="w-full">
              ...
              <RichTextEditor
                ...
                onChange={(newContent) =>
                  handleInputChange("advantages", "content", newContent)
                }
                controlled={true}
              />
            </div>
          ...
          <div className="space-y-4">
            <div className="w-full">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleInputChange("ourExpertise", "title", e.target.value)
                }
              />
            </div>
            <div className="w-full">
              ...
              <RichTextEditor
                ...
                onChange={(newContent) =>
                  handleInputChange("ourExpertise", "content", newContent)
                }
                controlled={true}
              />
            </div>
          ...
          <div className="space-y-4">
            <div className="w-full">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleInputChange("companyInfo", "title", e.target.value)
                }
              />
            </div>
            <div className="w-full">
              ...
              <RichTextEditor
                ...
                onChange={(newContent) =>
                  handleInputChange("companyInfo", "content", newContent)
                }
                controlled={true}
              />
            </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handleInputChange("meta", "title", e.target.value)
                }
              />
            </div>
            <div>
              ...
              <Textarea
                ...
                onChange={(e) =>
                  handleInputChange("meta", "description", e.target.value)
                }
              />
            </div>
          </div>
